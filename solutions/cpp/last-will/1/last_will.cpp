...
namespace estate_executor {
    ...
    int assemble_code() {
        int red_frag{zhang::red::code_fragment() + khan::red::code_fragment() + garcia::red::code_fragment()};
        int blue_frag{zhang::blue::code_fragment() + khan::blue::code_fragment() + garcia::blue::code_fragment()};

        return red_frag * blue_frag;
    }
}